...
Below is a Pie Chart showcasing the proportion of male to female riders. 
```{r}
malecount= length(which(bikesample$gender==1)) #number of male riders
femalecount= length(which(bikesample$gender==2)) #number of female riders
malepercent= malecount/(malecount+femalecount) #proporation of male riders who use citi bike
...
```
#Conlcusion and recommendation: #Areas in upper Manhattan and Brooklyn are demonstating a bike shortage. Those could be areas that citibike company can increase bike capacity to current stations or set up new bike stations in neighbour streets.
