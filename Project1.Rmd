...
ageTeens$stoptime <- as.POSIXlt(ageTeens$starttime, tz = "", "%m/%d/%Y %H:%M:%OS", optional = FALSE)
...
#numJanTeens <- sum(which(ageTeens$hour == 0))
#plot(x = ageTeens$hour, y = numJanTeens, type = "n")
```
